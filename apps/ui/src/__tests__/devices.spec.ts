...
// deviceKind()/readInt()/matrixInputs() were removed with the driver-agnostic
// widget rewrite — see lib/widgets.ts + composables/useDeviceWidgets.ts and
// __tests__/widgets.spec.ts for their replacements.
